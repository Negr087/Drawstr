...
<div className="absolute right-4 bottom-40 md:bottom-4 flex items-center gap-1 bg-card/80 backdrop-blur-sm border border-border rounded-lg p-1 shadow-lg">
  <Tooltip>
    <TooltipTrigger asChild>
